...
namespace Mvc21BITV01MidTest.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        public HoaDonsController(MyeStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var myeStoreContext = _context.HoaDons.Include(h => h.MaKhNavigation).Include(h => h.MaNvNavigation).Include(h => h.MaTrangThaiNavigation);
